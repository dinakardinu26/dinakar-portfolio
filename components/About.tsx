    ...
    <section className="py-24 bg-white dark:bg-[#121212] relative z-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-8 md:px-24 flex flex-col md:flex-row gap-16">
        ...
        <div className="md:w-2/3 space-y-6 text-lg text-gray-700 dark:text-gray-300 font-light leading-relaxed">
          <p>
            I am a <strong className="font-semibold text-gray-900 dark:text-white">Project Analyst in Performance Management &amp; Business Consulting</strong>, with hands-on experience in organizational performance improvement and business transformation across the manufacturing sector.
          </p>
          <p>
          ...
          <p>
            I have contributed to multiple organizational restructuring and business transformation projects, delivering work in defining the strategic way forward, KPI architecture, Performance Management System (PMS) design, process optimization, MIS &amp; executive dashboard development, and cross-functional organizational analytics.
          </p>
          <p>
          ...
          <div className="pt-6">
             <a href="/Dinakar_S_PMS.pdf" download="Dinakar_S_PMS.pdf" className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-black font-semibold rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">
               <Download size={18} />
               Download Resume
             </a>
          </div>
