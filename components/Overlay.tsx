...
export default function Overlay() {
  ...
  // Section 1.5: "AI-Driven Business Excellence" — top-left, appears at 10% (looking up) fades at 24%
  const opacity15 = useTransform(scrollYProgress, [0.10, 0.16, 0.21, 0.26], [0, 1, 1, 0]);
  const y15 = useTransform(scrollYProgress, [0.10, 0.18], [30, 0]);
